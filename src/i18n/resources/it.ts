...
import sponsors from '../../locales/it/sponsors.json';
import travel from '../../locales/it/travel.json';
import lodging from '../../locales/it/lodging.json';
import invitationLetter from '../../locales/it/invitationLetter.json';
