...
import sponsors from '../../locales/uk/sponsors.json';
import travel from '../../locales/uk/travel.json';
import lodging from '../../locales/uk/lodging.json';
import invitationLetter from '../../locales/uk/invitationLetter.json';
